...
from app.services.pipeline.multi_image import captions_per_image, merge_tags_for_two_images


def test_merge_tags_for_two_images_uses_intersection():
    tags_image_1 = [
    ...
    merged = merge_tags_for_two_images(tags_image_1, tags_image_2, max_tags=5)

    assert merged.strategy == "intersection"
...
def test_merge_tags_for_two_images_fallbacks_to_higher_score_image():
    tags_image_1 = [
    ...
    merged = merge_tags_for_two_images(tags_image_1, tags_image_2, max_tags=2)

    assert merged.fallback == "image_1_higher_avg_score"
