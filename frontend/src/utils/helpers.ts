...
export const mapApiUserToUser = (raw: any): User => {
   ...
   return {
      ...
      shippingHouseNumber: raw.shippingHouseNumber ?? raw.shipping_house_number ?? '',
      shippingPostalCode: raw.shippingPostalCode ?? raw.shipping_postal_code ?? '',
      ...
      // Zahlungsinfo
      preferred_payment: raw.preferred_payment ?? raw.preferredPayment ?? undefined,
