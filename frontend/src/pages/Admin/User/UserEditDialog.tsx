                ...
                <div className="p-fluid p-formgrid p-grid user-edit-dialog__grid">
                    ...
                    <div className="p-field p-col-12 p-md-6">
                        ...
                        <Dropdown
                            ...
                            onChange={(e) =>
                                handleFieldChange('role', e.value)
                            }
                            style={{ width: '100%' }}
                        />
                    </div>
                    <div className="p-field p-col-12 p-md-6">
                        ...
                        <Dropdown
                            ...
                            onChange={(e) =>
                                handleFieldChange('accountStatus', e.value)
                            }
                            style={{ width: '100%' }}
                        />
                    </div>
                    ...
                    <div className="p-field p-col-12 p-md-4">
                        <label htmlFor="shippingHouseNumber">
                            Liefer-Hausnr.
                        </label>
                        <InputText
                    ...
                    <div
                        className="p-field-checkbox p-col-12 p-md-6 user-edit-dialog__newsletter"
                    >
                        <Checkbox
                            inputId="newsletter"
