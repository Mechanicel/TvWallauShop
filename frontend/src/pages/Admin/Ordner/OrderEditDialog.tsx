            ...
            <div className="order-edit-dialog">
                <div className="order-expansion__cols">
                    <div>
                        ...
                        <ul className="kv">
                            ...
                            <li><span>E-Mail</span><span>{user.email}</span></li>
                            <li>
                                <span>Name</span>
                                <span>
                        ...
                        <div className="orders-field">
                            <Dropdown
                                ...
                                onChange={(e: DropdownChangeEvent) =>
                                    setEditStatus(e.value as OrderStatus)
                                }
                ...
                <DataTable value={order.items} responsiveLayout="scroll">
                    ...
                    <Column
                        field="price"
                        header="Preis"
                        body={(item: any) => `${Number(item.price).toFixed(2)} €`}
                    />
                </DataTable>

                {/* Footer mit Löschen / Abbrechen / Speichern */}
                <div
                    className="dialog-footer mt-3"
