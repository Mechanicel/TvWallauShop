...
const ProductDialog: React.FC<ProductDialogProps> = ({
   ...
   return (
      <Dialog visible={visible} style={{ width: '650px' }} header={title} modal footer={footer} onHide={onHide}>
         {!product ? null : (
            <div className="p-fluid">
               {/* Name */}
               <div className="p-field">
                  <label htmlFor="name">Name</label>
                  <InputText id="name" value={product.name} onChange={(e) => updateField('name', e.target.value)} />
               </div>
               ...
               <div className="p-field">
                  ...
                  <InputNumber
                     id="price"
                     value={product.price}
                     onValueChange={(e) => updateField('price', e.value ?? product.price)}
                     mode="currency"
                     currency="EUR"
                     locale="de-DE"
                  />
               ...
               <div className="p-field">
                  ...
                  {product.sizes.map((size, index) => (
                     <div key={index} className="size-row">
                        ...
                        <InputNumber
                           value={size.stock}
                           onValueChange={(e) => handleSizeChange(index, 'stock', e.value ?? 0)}
                           placeholder="Bestand"
                        />
                        <Button
                           icon="pi pi-trash"
