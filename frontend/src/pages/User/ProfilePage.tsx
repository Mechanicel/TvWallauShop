            ...
            <div className="profile-card">
                ...
                <section>
                    ...
                    <div className="profile-grid">
                        <EditableField label="Vorname" value={form.first_name} edit={isEditing} onChange={(v) => handleChange('first_name', v)} />
                        <EditableField label="Nachname" value={form.last_name} edit={isEditing} onChange={(v) => handleChange('last_name', v)} />
                ...
                <section>
                    ...
                    <div className="profile-grid">
                        ...
                        <EditableField label="Hausnummer" value={form.house_number} edit={isEditing} onChange={(v) => handleChange('house_number', v)} />
                        <EditableField label="PLZ" value={form.postal_code} edit={isEditing} onChange={(v) => handleChange('postal_code', v)} />
                ...
                <section>
                    <h4>Einstellungen</h4>
                    <div className="profile-grid">
                        <EditableField label="Bezahlung" value={form.preferred_payment} edit={isEditing} onChange={(v) => handleChange('preferred_payment', v)} />
                        <div className="p-field">
                            <label>Newsletter</label>
                            <InputText value={form.newsletter_opt_in ? 'Ja' : 'Nein'} disabled />
                        </div>
                    </div>
                </section>
                ...
                <div className="profile-actions">
                    {!isEditing ? (
                        <Button label="Bearbeiten" icon="pi pi-pencil" onClick={() => setIsEditing(true)} />
                    ) : (
                        <>
                            <Button label="Abbrechen" className="p-button-text" onClick={() => setIsEditing(false)} />
